...
const render: TemplateRender = (theme, w) => {
  const l1 = theme.fg("accent", "━━ ") + theme.fg("warning", "提燈") + theme.fg("accent", " ━━");
  const l2 = theme.fg("accent", "◉ ") + theme.fg("text", "F.R.I.D.A.Y.") + theme.fg("accent", " ◉");
  const l3 = theme.fg("muted", "居酒屋 · 深夜");

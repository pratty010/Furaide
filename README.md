...
|-----------|---------|-------------|
| `opencode/` | [OpenCode](https://opencode.ai) | 30-agent fleet: 12 domain specialists, 16 shared subagents, 4 gate plugins, web-tools plugin (3 tools, AI Studio / Vertex AI auto transport), Kitsune brand-builder (opt-in) |

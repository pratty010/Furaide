...
import { V2_FLEET } from '../lib/agent-fleet-map.mjs';
...
const survivors = V2_FLEET.filter(name => !['general', 'explore', 'scout'].includes(name));
...
test('config covers exactly the interim v2 fleet', () => {
  ...
  expect(configNames.size).toBe(V2_FLEET.length);

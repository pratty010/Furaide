...
Before dispatching, confirm role_target (job title and seniority). Time horizon defaults to 6 months if not provided. Collect any constraints (budget, time availability, certification preferences) if the user mentions them.

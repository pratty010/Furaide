# cli/src/mekiki/improve.py
import json
from collections import Counter
from datetime import datetime, timezone
from pathlib import Path
from mekiki import db, config
from mekiki.paths import evidence_dir
...
```
mekiki improve --mark {skill} applied
mekiki improve --mark {skill} rejected
```
"""

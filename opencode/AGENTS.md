...
The fleet: 12 domain specialists, 15 shared subagents dispatched by specialists, 2 general escape-hatch agents (Tanuki, Karasu-tengu), 4 gate plugins always active, plus the web-tools plugin. The brand-builder bundle (Kitsune + 8 sub-familiars) is opt-in and in development; not loaded by default.

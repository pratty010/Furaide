...
If no sections are specified, default to all five: headline, about, experience, featured, skills. Ask for the role target if not provided — the optimization will proceed without it but mark confidence degraded.
